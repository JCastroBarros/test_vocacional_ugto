...
- **Reportes Automáticos:** Generación inmediata de resultados en formato **PDF**.
- **Gestión de Datos:** Exportación de resultados a **Excel**.
- **Metodología Validada:** Basado 100% en la fuente oficial de la UGTO.
...
## 👤 Sistematización
Desarrollado por: **Julián Castro**
📩 Contacto: [castrobarrosjulian@gmail.com](mailto:castrobarrosjulian@gmail.com)
